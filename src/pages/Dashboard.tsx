...
export function Dashboard() {
  ...
  const disponibleMes = (settings.remanente_mes_anterior || 0) + ingresosMes - gastosMes;
  ...
  let donutData = [];
  const libre = Math.max(0, disponibleMes);
  if (gastosMes === 0 && libre === 0) {
    donutData = [{ name: 'Sin datos', value: 1, color: '#333333' }];
  } else {
    donutData = [
      { name: 'Gastos', value: gastosMes, color: '#f43f5e' },
      { name: 'Disponible', value: libre, color: '#00e676' }
    ...
    ⚙ Ajustes
      ...
      <div className="grid gap-4 mb-4">
        <Card className="border border-white/10 bg-gradient-to-br from-card/90 via-card/50 to-background/80 backdrop-blur-xl relative overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.8)] group hover:border-primary/20 transition-all duration-500">
          ...
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10 p-5 sm:p-6 pb-2 sm:pb-2">
            <CardTitle className="text-[13px] sm:text-sm font-medium text-muted-foreground/80 uppercase tracking-wider">Disponible del Mes</CardTitle>
            <button 
          ...
          <CardContent className="relative z-10 p-5 sm:p-6 pt-0 sm:pt-0">
            ...
            <div className="flex items-center mt-3 sm:mt-4 space-x-3">
              ...
              <p className="text-[11px] sm:text-sm text-muted-foreground/80">Balance disponible este mes (excluye bolsillos apartados)</p>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2.5 sm:gap-4">
        <Card className="border border-white/5 bg-card/40 backdrop-blur-md relative overflow-hidden group hover:border-emerald-500/30 transition-all duration-500 p-3 sm:p-5">
          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            <div className="flex items-center justify-between mb-2.5 sm:mb-3">
               <span className="text-[10px] sm:text-[11px] font-medium text-emerald-400/90 uppercase tracking-widest">Ingresos</span>
        ...
        <Card className="border border-white/5 bg-card/40 backdrop-blur-md relative overflow-hidden group hover:border-rose-500/30 transition-all duration-500 p-3 sm:p-5">
          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
             <div className="flex items-center justify-between mb-2.5 sm:mb-3">
               <span className="text-[10px] sm:text-[11px] font-medium text-rose-400/90 uppercase tracking-widest">Gastos</span>
          ...
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4 relative z-10 px-5 sm:px-6 pt-5 sm:pt-6">
            <div className="flex items-center space-x-3">
              ...
              <CardTitle className="text-[13px] sm:text-sm font-medium text-muted-foreground/80 uppercase tracking-wider">
                Resumen Financiero <span className="ml-1 text-[10px] text-muted-foreground font-normal normal-case">({format(new Date(), 'MMM yy', { locale: es })})</span>
              </CardTitle>
            </div>
          </CardHeader>

          <CardContent className="h-[auto] relative z-10 px-5 sm:px-6 pb-6">
            <div className="flex items-center justify-center w-full h-[200px] sm:h-[240px] relative mt-2 mb-6">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                ...
                <span className={`text-[10px] sm:text-xs font-medium mt-1 ${isDeficit ? 'text-rose-500/80' : 'text-muted-foreground/80'}`}>
                  {isDeficit ? 'Sobregasto' : `${getPercent(disponibleMes)}% restante`}
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 mt-5">
              ...
              <div className="flex flex-col items-center sm:items-start p-2.5 sm:p-4 rounded-2xl bg-white/[0.02] border border-white/[0.03] hover:bg-white/[0.05] transition-all duration-300">
                ...
                <span className="text-[9px] sm:text-[10px] text-muted-foreground/70 mt-1 whitespace-nowrap font-medium">Restante</span>
              </div>
              ...
              <div className="flex flex-col items-center sm:items-start p-2.5 sm:p-4 rounded-2xl bg-white/[0.02] border border-white/[0.03] hover:bg-white/[0.05] transition-all duration-300">
                <div className="flex items-center space-x-1.5 mb-1.5 sm:mb-2">
                  ...
                  <span className="text-[9px] sm:text-[10px] text-muted-foreground font-medium uppercase tracking-widest">Ingresos</span>
                </div>
                ...
                <span className="text-[9px] sm:text-[10px] text-muted-foreground/70 mt-1 whitespace-nowrap font-medium">Este mes</span>
              </div>
              ...
              <div className="flex flex-col items-center sm:items-start p-2.5 sm:p-4 rounded-2xl bg-white/[0.02] border border-white/[0.03] hover:bg-white/[0.05] transition-all duration-300">
                <div className="flex items-center space-x-1.5 mb-1.5 sm:mb-2">
                  ...
                  <span className="text-[9px] sm:text-[10px] text-muted-foreground font-medium uppercase tracking-widest">Gastos</span>
                </div>
                ...
                <span className="text-[9px] sm:text-[10px] text-muted-foreground/70 mt-1 whitespace-nowrap font-medium">{getPercent(gastosMes, ingresosMes)}%</span>
              </div>
            </div>
          </CardContent>
        </Card>
             ...
             <div className="relative z-10 px-6 sm:px-10 pt-4 sm:pt-10 pb-8 sm:pb-10">
               ...
               <div className="space-y-6">
                 ...
                 <div className="flex justify-between items-center group">
                   <div className="flex items-center space-x-4">
                     ...
                     <div className="flex flex-col">
                       <span className="font-semibold text-sm sm:text-base text-foreground/90">Ingresos</span>
                 ...
                 <div className="flex justify-between items-center group">
                   <div className="flex items-center space-x-4">
                     ...
                     <div className="flex flex-col">
                       <span className="font-semibold text-sm sm:text-base text-foreground/90">Gastos</span>
               ...
               <div className="flex justify-between items-center mb-6 relative p-4 rounded-3xl bg-white/[0.02] border border-white/5 shadow-[inset_0_0_20px_rgba(255,255,255,0.02)]">
                 <div className="flex items-center space-x-3">
                   ...
                   <span className="font-bold text-muted-foreground uppercase tracking-widest text-xs sm:text-sm">Disponible</span>
                 </div>
               ...
               <div className="flex justify-between items-center group bg-white/[0.01] p-3 -mx-3 rounded-2xl">
                ...
                <div className="flex justify-between items-center group bg-[#00e676]/5 border border-[#00e676]/10 p-3 -mx-3 rounded-2xl mt-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col">
                      <span className="font-semibold text-xs sm:text-sm text-[#00e676]">Capital Líquido Total</span>
                      <span className="text-[10px] sm:text-[11px] text-muted-foreground/70">Disponible + Bolsillos</span>
                    </div>
                  </div>
