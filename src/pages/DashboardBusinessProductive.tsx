...
export default function DashboardBusinessProductive() {
  ...
  console.log("SOY PRODUCTIVO", activeProfile?.profile_type);
  ...
  return (
    <div className="space-y-6">
        <div className="mb-6 rounded-3xl border border-emerald-500/30 bg-emerald-500/10 p-6">
  <h2 className="text-3xl font-bold text-emerald-400">
🌱 MODO PRODUCTIVO ACTIVADO  </h2>

  <p className="mt-2 text-sm text-muted-foreground">
Perfil agropecuario independiente  </p>
</div>
...
const esNegocio = confirm(
  "¿Este perfil es un negocio?\n\nAceptar = Negocio\nCancelar = Hogar"
);
console.log("PASO 2");
...
>
  ...
  Ventas menos costos del período
</p>
            </div>
          </CardContent>
        </Card>
               ...
               <div className="flex justify-between items-center group bg-white/[0.01] p-3 -mx-3 rounded-2xl">
                ...
                <div className="flex justify-between items-center group bg-[#00e676]/5 border border-[#00e676]/10 p-3 -mx-3 rounded-2xl mt-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex flex-col">
                      <span className="font-semibold text-xs sm:text-sm text-[#00e676]">Capital Total del Proyecto</span>
                      <span className="text-[10px] sm:text-[11px] text-muted-foreground/70">Inversión acumulada + ahorros</span>
                    </div>
                  </div>
